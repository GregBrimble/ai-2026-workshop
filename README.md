...
Welcome to my AI 2026 workshop! In this workshop, you'll enhance a full-stack React application with thoughtful sprinklings of AI.
...
1.  **Clone this repository** (if you haven't already):
    ...
    ```bash
    git clone https://github.com/GregBrimble/ai-2026-workshop.git
    ```
